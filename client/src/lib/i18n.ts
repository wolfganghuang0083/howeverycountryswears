...
export const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  ...
  es: {
    ...
    "nav.blog": "Blog",
    "nav.dashboard": "Panel",
    "nav.getBook": "Conseguir el libro",
    "nav.signIn": "Iniciar sesión",
    "nav.signOut": "Cerrar sesión",
    "nav.language": "Idioma",
    "card.play": "Reproducir",
    "card.locked": "Solo dueños del libro",
    "card.signInToListen": "Inicia sesión para escuchar",
    "card.getBookToUnlock": "Consigue el libro para desbloquear",
    "card.type": "Tipo",
    "card.literal": "Literal",
    "card.feelsLike": "Se siente como",
    "card.risk": "Riesgo",
    "card.register": "Registro",
    "card.copyLink": "¡Enlace copiado!",
    "card.share": "Compartir",
    "card.permalink": "Enlace permanente",
    "home.hero.title": "How Every Country Swears",
    "home.hero.subtitle": "Una guía cultural de la blasfemia global",
    "home.stats.phrases": "Frases",
    "home.stats.countries": "Países",
    "home.stats.regions": "Regiones",
    "home.featured.title": "Frases destacadas",
    "home.featured.subtitle": "Gemas de todo el mundo",
    "home.regions.title": "Explorar por región",
    "home.regions.subtitle": "Descubre la blasfemia entre culturas",
    "home.cta.title": "Consigue la guía completa",
    "home.cta.subtitle": "Desbloquea las 1.000 frases con audio, contexto cultural y más",
    "home.cta.button": "Conseguir el libro",
    "home.explore": "Explorar países",
    "home.viewAll": "Ver todo",
    "country.cards": "Tarjetas de frases",
    "country.culture": "Contexto cultural",
    "country.pattern": "Patrón dominante",
    "country.tone": "Dependencia del tono",
    "country.warning": "Aviso de Friendly Fire",
    "country.locked": "Contenido exclusivo para dueños del libro",
    "country.backToCountries": "Volver a países",
    "country.phrases": "frases",
    "country.culturalNotes": "Notas culturales",
    "region.countries": "Países",
    "region.backToRegions": "Volver a regiones",
    "rankings.title": "Rankings",
    "rankings.subtitle": "Cómo se clasifican las frases en el mundo",
    "book.title": "Conseguir el libro",
    "book.subtitle": "La guía completa de la blasfemia global",
    "book.buyNow": "Comprar ahora",
    "community.title": "Comunidad",
    "community.submit": "Enviar una frase",
    ...
    "phrase.backToCountry": "Volver al país",
    "phrase.reviews": "Reseñas",
    "phrase.addReview": "Añadir reseña",
    "phrase.noReviews": "Aún no hay reseñas. ¡Sé el primero!",
    "common.loading": "Cargando...",
    "common.error": "Algo salió mal",
    "common.comingSoon": "Próximamente",
    "common.backToHome": "Volver al inicio",
    "common.search": "Buscar",
    "common.searchPlaceholder": "Buscar países o frases...",
